...
- **SPEC §7** (OpenAPI, trusted proxies / IP allow-list, rate limit / CORS / headers, probe access) shipped in **v1.4.0**. Further edge work still via GSD milestones — not drive-by commits on `main`.
